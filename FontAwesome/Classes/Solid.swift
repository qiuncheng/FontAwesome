public extension FontAwesome {
    struct Solid {
        ...
        public static let politicals: [FontAwesome] = [
            Political.balancescale,
            Political.balancescaleleft,
            Political.balancescaleright,
            Political.democrat,
            Political.flagusa,
        ...
        public static let usersPeoples: [FontAwesome] = [
            ...
            UsersPeople.pray,
            UsersPeople.restroom,
            UsersPeople.running,
            UsersPeople.skating,
            UsersPeople.skiing,
            UsersPeople.skiingnordic,
            UsersPeople.snowboarding,
            UsersPeople.streetview,
            UsersPeople.user,
            UsersPeople.useralt,
        ...
        public static let scienceFictions: [FontAwesome] = [
            ...
            ScienceFiction.meteor,
            ScienceFiction.moon,
            ScienceFiction.robot,
            ScienceFiction.rocket,
            ScienceFiction.satellite,
            ScienceFiction.satellitedish,
            ScienceFiction.spaceshuttle,
            ScienceFiction.userastronaut,
        ]
        ...
        public static let automotives: [FontAwesome] = [
            ...
            Automotive.oilcan,
            Automotive.tachometeralt,
            Automotive.taxi,
            Automotive.truckmonster,
            Automotive.truckpickup,
        ]
        ...
        public static let objects: [FontAwesome] = [
            ...
            Objects.unlock,
            Objects.unlockalt,
            Objects.utensilspoon,
            Objects.wallet,
        ]
        public struct Camping {
            public static let mapmarked = FontAwesome("\u{f59f}")
            public static let mapmarkedalt = FontAwesome("\u{f5a0}")
        }
        
        public static let campings: [FontAwesome] = [
            Camping.mapmarked,
            Camping.mapmarkedalt,
        ]
        ...
        public static let business: [FontAwesome] = [
            ...
            Business.percent,
            Business.phoneslash,
            Business.phonesquare,
            Business.phonesquarealt,
            Business.phonevolume,
            Business.registered,
            Business.table,
            Business.tasks,
            Business.trademark,
        ...
        public static let maritimes: [FontAwesome] = [
            ...
            Maritime.binoculars,
            Maritime.compass,
            Maritime.dharmachakra,
            Maritime.frog,
            Maritime.ship,
            Maritime.skullcrossbones,
            Maritime.swimmer,
            Maritime.water,
            Maritime.wind,
        ]
        ...
        public static let designs: [FontAwesome] = [
            ...
            Design.pencilalt,
            Design.pencilruler,
            Design.rulercombined,
            Design.rulerhorizontal,
            Design.rulervertical,
            Design.splotch,
            Design.spraycan,
            Design.stamp,
            Design.swatchbook,
        ...
        public static let beverages: [FontAwesome] = [
            ...
            Beverage.blender,
            Beverage.flask,
            Beverage.glasscheers,
            Beverage.glasswhiskey,
            Beverage.mughot,
            Beverage.winebottle,
            Beverage.wineglassalt,
        ]
        public struct Alert {
        ...
        public static let musics: [FontAwesome] = [
            ...
            Music.microphone,
            Music.microphonealt,
            Music.microphonealtslash,
            Music.microphoneslash,
            Music.music,
            Music.play,
            Music.recordvinyl,
            Music.slidersh,
        ...
        public static let interfaces: [FontAwesome] = [
            ...
            Interfaces.icursor,
            Interfaces.info,
            Interfaces.infocircle,
            Interfaces.language,
            Interfaces.medal,
            Interfaces.minuscircle,
            Interfaces.minussquare,
            Interfaces.pluscircle,
            Interfaces.plussquare,
            Interfaces.question,
            Interfaces.questioncircle,
            Interfaces.quoteleft,
            Interfaces.quoteright,
            Interfaces.redo,
            Interfaces.redoalt,
            Interfaces.reply,
            Interfaces.replyall,
            Interfaces.rss,
            Interfaces.rsssquare,
            Interfaces.screwdriver,
            Interfaces.search,
            Interfaces.searchminus,
            Interfaces.searchplus,
            Interfaces.share,
            Interfaces.sharealt,
            Interfaces.sharealtsquare,
            Interfaces.sharesquare,
            Interfaces.signinalt,
            Interfaces.signoutalt,
            Interfaces.signal,
            Interfaces.sort,
            ...
            Interfaces.toggleoff,
            Interfaces.toggleon,
            Interfaces.tools,
            Interfaces.trash,
            Interfaces.trashalt,
            Interfaces.trashrestore,
            Interfaces.trashrestorealt,
            Interfaces.undo,
            Interfaces.undoalt,
            Interfaces.upload,
            Interfaces.wrench,
        ...
        public static let shoppings: [FontAwesome] = [
        ...
        public static let tabletopGamings: [FontAwesome] = [
            TabletopGaming.bookdead,
            TabletopGaming.diced20,
            TabletopGaming.diced6,
            TabletopGaming.dragon,
            TabletopGaming.dungeon,
            TabletopGaming.fistraised,
            TabletopGaming.hatwizard,
            TabletopGaming.ring,
            TabletopGaming.scroll,
        ]
        ...
        public static let energys: [FontAwesome] = [
            ...
            Energy.batteryfull,
            Energy.batteryhalf,
            Energy.batteryquarter,
            Energy.batterythreequarters,
            Energy.broadcasttower,
            Energy.burn,
            Energy.chargingstation,
            Energy.fire,
            Energy.firealt,
            Energy.gaspump,
            Energy.industry,
        ...
        public static let charitys: [FontAwesome] = [
            ...
            Charity.dove,
            Charity.globe,
            Charity.handholdingheart,
            Charity.handholdingusd,
            Charity.handshelping,
            Charity.leaf,
